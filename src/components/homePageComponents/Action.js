      ...
      <div>
        ...
        <ul>
          ...
          {homeData[0] >= 61.38 * 1.25 && (
            <li>
              Use LED Lighting and BLDC fans: LED bulbs use up to 90% less
              energy than traditional incandescent bulbs and can last up to 25
              times longer. BLDC fans are called brushless dc fans and consumes
              lower electricity compare to normal induction fans.
            </li>
          )}
          {homeData[0] >= 61.38 * 1.5 && (
            <li>
              Use Energy-Efficient Appliances: Look for appliances with the
              ENERGY STAR label, which indicates that they meet energy
              efficiency guidelines set by the U.S. Environmental Protection
              Agency. Using energy-efficient appliances can significantly reduce
              the amount of electricity you use.
            </li>
          )}
          {homeData[0] >= 61.38 * 2 && (
            <li>
              Install Solar Panels: Installing solar panels on your rooftop is
              an effective way to reduce your electricity consumption from the
              grid, and therefore reduce your carbon footprint.
            </li>
          )}
        </ul>
      </div>
      ...
      <div>
        ...
        <ul>
          <li>
            ...
            carbon footprint than a diet based on meat and dairy products. You
            don't have to give up meat entirely, but reducing your meat
            consumption and incorporating more plant-based meals into your diet
            can make a big difference.
          </li>
          {totalData[2] >= 183 * 1.25 && (
            <li>
              Choose locally sourced and seasonal foods: When you buy food that
              is grown locally and in season, you're reducing the carbon
              footprint associated with transportation and refrigeration. You
              can also visit farmers' markets, where you can meet local farmers
              and learn about the foods they grow.
            </li>
          )}
          {totalData[2] >= 183 * 1.5 && (
            <li>
              Reduce food waste: When food is thrown away, it contributes to
              greenhouse gas emissions. Try to plan your meals and buy only what
              you need, and use up leftovers to avoid food waste.
            </li>
          )}
          {totalData[2] >= 183 * 2 && (
            <li>
              Use reusable containers and bags: When you bring your own reusable
              containers and bags to the grocery store, you can reduce the
              amount of plastic and other materials that are used and discarded.
            </li>
          )}
        </ul>
      </div>
